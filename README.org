...
#+CAPTION: Clock summary at [2026-02-07 Sat 11:55]
| Headline                     | Time  |       |
|------------------------------+-------+-------|
| *Total time*                   | *23:04* |       |
|------------------------------+-------+-------|
| Tasks                        | 23:04 |       |
| \_  Initial Setup / Planning |       |  1:00 |
| \_  Vibe coding              |       | 21:11 |
...
:LOGBOOK:
CLOCK: [2026-02-07 Sat 10:40]--[2026-02-07 Sat 10:44] =>  0:04
CLOCK: [2026-02-02 Mon 20:47]--[2026-02-02 Mon 20:56] =>  0:09
CLOCK: [2026-01-28 Wed 15:29]--[2026-01-28 Wed 15:40] =>  0:11
CLOCK: [2026-01-20 Tue 19:17]--[2026-01-20 Tue 19:26] =>  0:09
CLOCK: [2026-01-18 Sun 12:18]--[2026-01-18 Sun 12:32] =>  0:14
CLOCK: [2026-01-04 Sun 15:10]--[2026-01-04 Sun 15:16] =>  0:06
CLOCK: [2026-01-04 Sun 14:57]--[2026-01-04 Sun 15:04] =>  0:07
:END:
** Vibe coding
:LOGBOOK:
CLOCK: [2026-02-07 Sat 10:44]--[2026-02-07 Sat 11:55] =>  1:11
CLOCK: [2026-02-02 Mon 20:56]--[2026-02-02 Mon 22:44] =>  1:48
CLOCK: [2026-01-30 Fri 19:28]--[2026-01-30 Fri 20:48] =>  1:20
CLOCK: [2026-01-28 Wed 15:40]--[2026-01-28 Wed 16:51] =>  1:11
CLOCK: [2026-01-25 Sun 13:23]--[2026-01-25 Sun 15:04] =>  1:41
CLOCK: [2026-01-22 Thu 10:52]--[2026-01-22 Thu 11:11] =>  0:19
CLOCK: [2026-01-20 Tue 19:26]--[2026-01-20 Tue 20:34] =>  1:08
CLOCK: [2026-01-19 Mon 15:43]--[2026-01-19 Mon 16:19] =>  0:36
CLOCK: [2026-01-18 Sun 12:33]--[2026-01-18 Sun 13:45] =>  1:12
...
** Day 20
Another productive session - implemented speeding up and slowing down
clips, and that's in just an hour!

** Day 19
Fixed splitting the connected clips, added an algorithm for
positioning the connected clips around the timeline. Also, added a
basic properties panel to change clip volume and speed.

I think we are getting closer to finalizing this experiment. When I am
able to edit and export my programming tutorials with this fully
vibe-coded software, I will consider this to be a success.

** Day 18
Added audio clips with cute waveform rendering, a menu, and the undo
stack. The last part needs some more testing; also there are still
small bugs with splitting connected clips, but overall a good progress
for an hour of work!

** Day 17
Very smooth session today. I used the Planning Mode for the first
time, to create a documentation for the Connected Clips feature. It
went quite well: I told Claude to do a web research on how that
feature works in Apple Final Cut and it was able to expand my basic
description of the feature and create a comprehensive Markdown doc.
This doc is now connected to AGENTS.md - let's see if that helps the
Agent to not introduce regression bugs like it used to do before...

** Day 16
Another classic AI Agent experience: one hour of frustrating back and
forth with the agent to fix the simplest thing, then a random fix that
magically worked.

After that just 20 minutes or so to implement a huge feature with
almost no bugs ¯\_(ツ)_/¯

** Day 15
Codex is still struggling with basic stuff. Moreover, my X session
restarted randomly during the vibe coding stream, so looks like just
15 minutes of banging my head against the wall today :)

** Day 14
I think that the idea of "jagged frontier" might be true. AI Agents
are absolutely amazing and better than humans in a variety of coding
tasks, but at some of the tasks they are just sooo bad.

Like today: we spend 30mins trying to fix the playhead behavior when
resizing a clip. Each time Codex claimed that the bug is fixed and
each time it was a lie. These types of interactions are just the
worst - much more exhausting than manual coding.

** Day 13
That was funny. Codex completely broke the app while trying to
implement the Connected Clips feature, and then Cursor told me I need
to pay more $$$ to continue :)

** Day 12
Finished the UX of the Project Manager. We now have a pretty capable
Video Editor, where we can insert clips from external files, change
the clip length and order in the timeline, save our changes to a
custom project file and export the final video!

There are still some minor bugs (and the missing frame bug resurfaced
again...) but that's something to be fixed soon.
